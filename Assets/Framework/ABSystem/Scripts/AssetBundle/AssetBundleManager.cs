...
namespace Tangzx.ABSystem
{
    ...
    public class AssetBundleManager : IABSystem, IUpdate, IOnDestroy
    {
        ...
        /// 可再次申请的加载数
        /// </summary>
        private int _requestRemain = MaxRequest;
        ...
        {
            Debug.LogWarning("Cant load AB : " + loader.bundleName);
            LoadComplete(loader);
        }
